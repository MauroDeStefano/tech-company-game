...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('projects', function (Blueprint $table) {
            ...
            $table->check('complexity >= 1 AND complexity <= 5', 'chk_valid_complexity');
            $table->check('value > 0', 'chk_positive_value');
            $table->check('difficulty_multiplier > 0', 'chk_positive_difficulty_multiplier');
        });
    }
