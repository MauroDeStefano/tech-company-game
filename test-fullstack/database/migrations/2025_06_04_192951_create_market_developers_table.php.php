...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('market_developers', function (Blueprint $table) {
            ...
            $table->index(['rarity', 'availability_weight'], 'idx_market_developers_rarity_weight');
            $table->index('specialization', 'idx_market_developers_specialization');
            $table->index(['min_company_level', 'min_money_required'], 'idx_market_developers_requirements');
